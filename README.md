...
The density-effect correction accounts for the polarization of the material. Essentially, it explains why liquid water at energies above 550 keV has a stopping power that is less than the stopping power for water vapour at the same energy. The modelling involves dialectric stopping or optics (i.e. transport of electromagnetic fields in solid-state materials). The electrons in the material are responsible for the absorption and re-emission of the "light" and the plasma frequence frequency plays a vital role in the theory. The electrons are represented by oscillators with resonance frequencies determined by the binding energies of the electrons of the material. In what sense can we represent an electron as an electromagnetic wave? A swift electron is like a delta-function in time which therefore leads to a broad range of frequencies after Fourier transformation. The density-effect concerns only the long-distance collisions (i.e. soft collisions). These gain more importance af high energies due to the Lorentz contraction of the field (it becomes pancake like at high energies rather than spherical).
