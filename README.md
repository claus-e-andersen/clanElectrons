...
The density-effect correction accounts for the polarization of the material. Essentially, it explains why liquid water at energies above 550 keV has a stopping power that is less than the stopping power for water vapour at the same energy. The modelling involves dialectric stopping or optics (i.e. transport of electromagnetic fields in solid-state materials). The electrons in the material are responsible for the absorption and re-emission of the "light". They are represented by oscillators with resonance frequencies determined by the binding energies of the electrons of the material. In what sense can we represent an electron as an electromagnetic wave? A swift electron is like a delta-function in time which therefore leads to a broad range of frequencies after Fourier transformation.
